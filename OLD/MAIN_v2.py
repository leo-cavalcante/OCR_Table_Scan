...
def savePic():
    ...
    shutil.copy(filename, f"/Users/leonardo.cavalcante/Downloads/{randomText}.{filenameSplitted[1]}")
    setPreviewPic('/Users/leonardo.cavalcante/Downloads/TEST.jpg')
...
# image_path = '/Users/leonardo.cavalcante/Documents/Education - Learning/GitHub/OCR_Table_Scan/Images_to_Treat/Image.webp'
